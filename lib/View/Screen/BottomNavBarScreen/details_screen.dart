...
class _DetailsScreenState extends State<DetailsScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      context.read<ReivewController>().review.clear();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: () async {
          try {
            await context.read<EventDetailsController>().getSingleEvent(
              eventId,
            );
            await context.read<EventDetailsController>().checkIfUserHasTicket(
              eventId,
            );
          } catch (_) {}
        },
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Padding(
                      ...
                      child: DetailsHighlightMessage(
                        message: highlights[index],
                      ),
                    );
                  },
                ),
                  ...
                  children: [
                    Consumer<ReivewController>(
                      builder: (context, reviewCtrl, child) {
                        return Text(
                          'Reviews (${reviewCtrl.totalReview})',
                          style: Theme.of(context).textTheme.titleMedium,
                        );
                      },
                    ),
